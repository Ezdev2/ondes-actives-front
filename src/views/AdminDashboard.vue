<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto  py-8">
      <!-- Navigation avec breadcrumb et vue conditionnelle -->
      <div v-if="!showEditor" class="mb-8">
        ...
        <div class="mt-8 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <!-- <div v-if="blogStore.loading" class="p-8 text-center">
          ...
          <div v-if="blogStore.posts.length === 0" class="p-8 text-center">
            ...
            <button @click="createPost" class="mt-4 text-green-600 hover:text-green-700 font-medium">
              Créer votre premier article
            </button>
          </div>

          <div v-else class="divide-y divide-gray-200">
            <div v-for="post in blogStore.posts" :key="post.id" class="p-6 hover:bg-gray-50 transition-colors">
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <div class="flex items-center gap-3 mb-2">
                    <h4 class="text-lg font-medium text-gray-900">{{ post.title }}</h4>
                    <span :class="post.draft ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'"
      ...
      <!-- Éditeur de blog (remplace le modal) -->
      <div v-else>
        <BlogEditor :post="editingPost" @close="closeEditor" @save="handleSavePost" />
      </div>
    </main>
    ...
    <div v-if="postToDelete" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <div class="flex gap-3">
          <button @click="postToDelete = null"
